...
main                                              // 
  ...
  jsr get_status                                  // 
  lda CONFIG_STATUS                               // 
  cmp #100                                        // if status != d, go to wifi setup
  bne jmp_main_menu                               // 
...
reset_screen:                                     // 
  jsr clear_keyboard_and_screen                   // 
  displayText DIVIDER_LINE, #0,#0                 // draw the divider line
  displayText text_reset_screen, #1,#11           // draw the menu title
  displayText DIVIDER_LINE, #2,#0                 // draw the divider line
  displayText text_reset_screen_1, #4, #0         // 
  displayText DIVIDER_LINE, #22,#0                // draw the divider line
get_reset_choice                                  // 
  jsr getKey                                      // 
  cmp #255                                        // 
  beq get_reset_choice                            // 
  cmp #121                                        // if user pressed y, do the reset
  bne exit_account_setup                          // any other key cancels the reset
  lda #244                                        // do the reset
  jsr wait_for_RTR                                // 
  sta $d502                                       // 
  ldy #0                                          // 
confirm_reset                                     // 
...
main_menu:                                        // 
  ...
  displayText DIVIDER_LINE, #2,#0                 // draw the divider line
                                                  // 
  displayText MLINE_MAIN1, #5,#3                  // wifi setup
                                                  // 
  lda CONFIG_STATUS                               // 
  cmp #101                                        // e
  bne main2                                       // 
  jmp skip_mm1                                    // 
main2                                             // 
  displayText MLINE_MAIN2, #7,#3                  // server setup
  lda CONFIG_STATUS                               // 
  cmp #119                                        // w
  bne acc_stup                                    // 
  jmp skip_mm1                                    // 
acc_stup                                          // 
  displayText MLINE_MAIN3, #9,#3                  // account setup
  lda CONFIG_STATUS                               // 
  cmp #115                                        // s
  bne more_items                                  // 
  jmp skip_mm1                                    // 
...
account_setup:                                    // 
  ...
  displayText TEXT_FACTORY_RESET, #17,#3          // 
  displayText DIVIDER_LINE, #22,#0                // draw the divider line
                                                  // 
  lda VICEMODE                                    // 
  cmp #1                                          // 
...
savecr .byte 0                                    // 
savecc .byte 0                                    // 
display_message:                                  // the RXBUFFER contains a message.
  mva COLCRS savecc                               // 
  mva ROWCRS savecr                               // 
  ldx #0                                          // 
make_room_loop                                    // 
...
rxb_loop                                          // 
  ...
  cmp #128                                        // 
  beq get_m_exit                                  // 
  cmp #254                                        // we use this as inverted space in messaging
  bne write_char                                  // 
...
UPDATEBOX: .byte $11,$12,$12,$12,$12,$12,$12,$12,$12,$12,$12,$12,$12,$12,$12,$12,$12// 
  ...
  .endl                                           // 
                                                  // 
  .local text_reset_screen                        // 
  .byte 'RESET TO DEFAULT'                        // 
  .endl                                           // 
                                                  // 
  ...
  .endl                                           // 
                                                  // 
  .local TEXT_FACTORY_RESET                       // 
  .byte '[SEL] Reset to defaults'                 // 
  .endl                                           // 
                                                  // 
